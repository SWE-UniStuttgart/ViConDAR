...
%                indLoopT  =  (LOS_points.slices(i1,ind_slice)-1)*input.distanceSlices+(input.focus_distances-input.ref_plane_dist);% [m] Distances where the measurements are focused  along the probe length
