...
% runs turbsim  to obtain the constrained.wnd. After simulation is done it 
% converts .wnd to global .mat format
%
% V.Pettas/F.Costa 
...
% Run Turbsim through DOS
[status,cmdout] = dos([input.TurbSimExe_path ' ' input.pathToTurbSim inputfile]); %add path to turbsim from input
