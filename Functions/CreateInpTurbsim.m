...
function CreateInpTurbsim (SaveName,TimeSeriesName,input,lidarMeas)
...
var = {TimeSeriesName,num2str(input.RandSeed),num2str(lidarMeas.TS.fullWF.nGridZ),num2str(lidarMeas.TS.fullWF.nGridY),num2str(lidarMeas.Pattern.timestep_pat_vec),num2str(lidarMeas.TS.fullWF.duration),...
