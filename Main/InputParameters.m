...
input.timeStep_Measurements = {[.2]}; %Time step between each single measured point. Add one value for each pattern [s]
...
input.sample_rate   = [1]; % [Hz] Lidar measurements sample rete
